...
import com.springboot.schoolmanagement.security.CustomUserDetailsService;
import com.springboot.schoolmanagement.security.JwtAuthFilter;
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            // Swagger UI & OpenAPI docs — all required paths
            .requestMatchers(
                "/swagger-ui/**",
                "/swagger-ui.html",
                "/v3/api-docs",
